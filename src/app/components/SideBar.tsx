...
import { setFontSize } from "../redux/FontSize";
      ...
      <div className="sidebar sidebar--closed">
        ...
        <div className="sidebar__wrapper">
          <div className="sidebar__top">
            <Link href="/for-youPage" className="sidebar__link--wrapper">
            ...
            <Link href="/libraryPage" className="sidebar__link--wrapper">
            ...
            {pathname.startsWith("/playerPage/") && (
          ...
          <div
            ...
            style={{
              marginBottom: pathname.startsWith("/playerPage/") ? "80px" : "0",
            }}
          >
            <a className="sidebar__link--wrapper" href="/settingsPage">
              <div className="sidebar__link--line "></div>
              <div className="sidebar__icon--wrapper">
                <svg
                  stroke="currentColor"
            ...
            <div
              ...
              onClick={isLoggedIn ? handleLogoutUser : handleOpenLoginModal}
            >
              <div className="sidebar__link--line "></div>
              <div className="sidebar__icon--wrapper">
                <svg
